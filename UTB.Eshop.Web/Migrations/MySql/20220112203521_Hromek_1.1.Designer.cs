...
namespace UTB.Eshop.Web.Migrations.MySql
{
    ...
    [Migration("20220112203521_UTB_1.1")]
    partial class Hromek_11
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UTB.Eshop.Web.Models.Entity.Rating", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("UTB.Eshop.Web.Models.Entity.Rating", b =>
                {
                    b.HasOne("UTB.Eshop.Web.Models.Entity.Product", null)
                        .WithMany("Ratings")
                        .HasForeignKey("ProductID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
